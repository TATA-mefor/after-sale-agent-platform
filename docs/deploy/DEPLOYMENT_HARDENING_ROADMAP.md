...
completed; V5.B.3.5 through V5.B.4 planned
...
tracing / correlation boundary 已完成。V5.B.3.5 production monitoring roadmap 和
...
2. V5.B.2 PGvector deployment：在 V5.A.1 opt-in `JdbcPolicyVectorRepository` 基础上补 broader opt-in live
   validation。
3. V5.B.3.5 planned monitoring：Grafana / log aggregation / alerting roadmap；OpenTelemetry / cross-service
