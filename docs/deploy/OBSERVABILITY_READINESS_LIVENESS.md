...
V5.B.3.2 later added Micrometer metrics foundation, V5.B.3.3 later added Prometheus opt-in exposure, and V5.B.3.4
later added local HTTP tracing / correlation for logs only. Grafana, OpenTelemetry, collector configuration,
distributed tracing, and production log aggregation remain future / opt-in production hardening work.
