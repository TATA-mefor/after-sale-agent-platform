...
exposure completed。V5.B.3.4 tracing / correlation boundary completed。OpenTelemetry、distributed tracing、
V5.B.3.5 production monitoring roadmap、auth、Kubernetes / Helm、release / rollback 和 production deployment
仍是后续任务。
