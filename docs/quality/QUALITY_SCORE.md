...
Status: active. V4.0 pre-flight fixes and V4.1 Tool / Skill Layer Foundation are completed. V4.2+ Spring AI, RAG,
PGvector, Policy Ingestion, Skill runtime migration, and Execution Tree skill nodes remain planned.
