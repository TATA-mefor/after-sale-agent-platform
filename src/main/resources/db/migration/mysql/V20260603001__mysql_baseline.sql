...
-- This migration contains schema only. Demo seed data from data-mysql.sql is intentionally not included.
-- This migration does not include secrets, prompt bodies, dataset files, or production data.
